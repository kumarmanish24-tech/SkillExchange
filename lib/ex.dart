                    ...
                    if (index < _totalSteps - 1)
                      Expanded(
                        child: AnimatedContainer(
                          duration: const Duration(milliseconds: 300),
                          height: 3,
                          color: index < _currentStep ? Colors.teal : Colors.grey[200],
                        ),
                      ),
                  ],
                ),
        ...
        Expanded(
          child: PageView(
            ...
            children: [
                  ...
                  children: [
                    ...
                    CircleAvatar(
                      ...
                      child: CircleAvatar(
                        ...
                        child: Icon(Icons.add_a_photo_outlined,color: Colors.teal,size: 35,),
                      ),
                    ),
                    SizedBox(height: 10,),
                    SizedBox(
                      ...
                      width: 150,
                      child: Column(
                        children: [Text("Add Profile Photo",style: TextStyle(fontWeight: FontWeight.w500,color: AppColors.darkfont,fontSize: 13),),
                          Text("JPG PNG up to 5MB",style: TextStyle(fontWeight: FontWeight.w400,color: AppColors.middark,fontSize: 13),)
                        ],
                      ),
                    ),
                    ...
                    SizedBox(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Enter First name', // The placeholder text
                          hintStyle: TextStyle(
                            color: Colors.grey,
                            fontSize: 16.0,
                    ...
                    SizedBox(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Choose a unique username', // The placeholder text
                          hintStyle: TextStyle(
                            color: Colors.grey,
                            fontSize: 16.0,
                            fontStyle: FontStyle.italic,
                  ...
                  children: [
                    ...
                    ListTile(
                      leading: Container(
                        ...
                        child: const Icon(Icons.perm_identity, color: Colors.teal),
                      ),
                      // Read Income Amount
                      title: Text(
                        'Name',
                    ...
                    ListTile(
                      leading: Container(
                        ...
                        child: const Icon(Icons.alternate_email_rounded, color: Colors.teal),
                      ),
                      // Read Income Amount
                      title: Text(
                        'Username ',
                    ...
                    SizedBox(
                      ...
                      child: TextField(
                        ...
                        textAlignVertical: TextAlignVertical.top, // 1. Align text to the top
                        ...
                        decoration: InputDecoration(
                          ...
                          contentPadding: EdgeInsets.only(top: 16.0, bottom: 16.0, right: 16.0),

                          // 3. Align the icon to the top instead of the center
                          prefixIcon: Container(
                            alignment: Alignment.topCenter,
                            width: 48, // Standard width for standard icon spacing
                            padding: EdgeInsets.only(top: 14.0), // Adjust this to line up perfectly with your text
                            child: Icon(
                              Icons.edit,
                              color: AppColors.theme,
                            ),
              ...
              Center(child: Text('Step 3: Verification phone/email code input')),
            ...
            children: [
              OutlinedButton(
                ...
                style: OutlinedButton.styleFrom(
                  side: BorderSide(color: _currentStep == 0 ? Colors.grey.shade300 : Colors.teal),
                ),
              ...
              ElevatedButton(
                ...
                child: Text(_currentStep == _totalSteps - 1 ? 'SUBMIT' : 'CONTINUE'),
              ),
            ],
          ),
        ),
